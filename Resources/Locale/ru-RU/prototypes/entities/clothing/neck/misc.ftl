...
ent-ClothingNeckLawyerbadge = значок адвоката
    .desc = Значок, свидетельствующий что владелец является "законным" юристом, сдавшим экзамен, необходимый для занятия юридической практикой.
    .suffix = { "" }
ent-ClothingNeckFlowerWreath = цветочный венок
    .desc = Венок из ярких цветов.

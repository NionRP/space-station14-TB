...
ent-BedsheetCaptain = одеяло капитана
    .desc = Оно украшено эмблемой, и соткано из революционно-нового вида нитей, понижающих шанс проникновения большинства нехимических веществ до 0,01%. Популярно среди многих современных капитанов.
    .suffix = { "" }
...
ent-BedsheetCult = одеяло культа
    .desc = Вам может присниться ужас, если вы будете спать под ним. Оно выглядит довольно потрепанным и светится колдовским сиянием.
    .suffix = { "" }
...
ent-BedsheetMime = одеяло мима
    ...
    .suffix = { "" }
ent-BedsheetNT = одеяло
    .desc = Имеет эмблему , и от него исходит аура долга.
    .suffix = { "" }
...
ent-BedsheetPurple = фиолетовое одеяло
    .desc = { ent-BedsheetBase.desc }
    .suffix = { "" }
ent-BedsheetQM = одеяло
    .desc = { ent-BedsheetBase.desc }
    .suffix = { "" }
ent-BedsheetRainbow = радужное одеяло
    .desc = { ent-BedsheetBase.desc }
    .suffix = { "" }
ent-BedsheetRD = одеяло с мензуркой
...
ent-BedsheetRed = красное одеяло
    .desc = { ent-BedsheetBase.desc }
    .suffix = { "" }
ent-BedsheetSyndie = одеяло
    .desc = Имеет эмблему, и от него исходит аура зла.
    .suffix = { "" }
